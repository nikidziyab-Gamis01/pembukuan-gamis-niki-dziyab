...
function BukuKasTab({ data, save, flash }) {
  ...
  const handleTambahUP = () => {
    if (!formUP.pihak.trim() || !Number(formUP.nominal)) {
      flash("Isi nama pihak dan nominal utang/piutang terlebih dahulu!");
      return;
    }
    ...
    const entry = {
      ...
      jenis: formUP.jenis,
      pihak: formUP.pihak.trim(),
      nominal: nominalAngka,
      keterangan: formUP.keterangan.trim() || "Transaksi manual",
      status: "Belum Lunas",
      terbayar: 0,
    };
    ...
    if (formUP.jenis === "UTANG") {
      nextBukuKas.unshift({
        ...
        jenis: "Kredit",
        nominal: nominalAngka,
        keterangan: `[Utang Toko] ${entry.pihak} | ${entry.keterangan}`,
      });
    } else {
      nextBukuKas.unshift({
        id: uid(),
        ...
        jenis: "Debit",
        nominal: nominalAngka,
        keterangan: `[Piutang Toko] ${entry.pihak} | ${entry.keterangan}`,
      });
    }

    save({
      ...safeData,
      utangPiutang: [entry, ...(safeData.utangPiutang || [])],
      bukuKas: nextBukuKas,
    });
