...
// ---------- FINAL UPGRADE: DASHBOARD, STAT, & FOOTER HAK CIPTA ----------
function Dashboard({ data, stockMap, stokAkhir }) {
  ...
  // Analisis 5 Produk Terlaris (Top Selling Products) dengan Optimasi Visual Text
  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1.3fr", gap: 16, alignItems: "stretch", marginBottom: 18 }}>
        ...
        {/* GRAFIK DENGAN PERBAIKAN LEBIH RAPI (MEMBERI JARAK PADA MARGIN KIRI KORIDOR TEXT) */}
        <SectionCard title="🔥 5 Produk Terlaris (Top Selling)" subtitle="Berdasarkan Volume Unit Terjual">
          <div style={{ height: 220 }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={topProductsData} layout="vertical" margin={{ top: 5, right: 15, left: 28, bottom: 5 }}>
                <CartesianGrid strokeDasharray="3 3" stroke={C.border} horizontal={false} />
                <XAxis type="number" tick={{ fontSize: 11, fill: C.muted }} axisLine={false} />
                <YAxis 
                  dataKey="sku" 
                  type="category" 
                  tick={{ fontSize: 11, fontWeight: 700, fill: C.primaryDark }} 
      ...
      {/* FOOTER HAK CIPTA PREMIUM PALING BAWAH HALAMAN DASBOR */}
      <div style={{ textAlign: "center", padding: "24px 0 10px", borderTop: `1px solid ${C.border}`, marginTop: 30 }}>
    ...
    <div>
      <SectionCard title="Catat Jualan / Barang Keluar Omnichannel" subtitle="Rekam pengeluaran stok komersial maupun alokasi biaya pengiriman sampel kreator gratis">
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(130px,1fr))", gap: 10 }}>
          ...
          <Field label="Kode Pesanan / Resi / Nama Staf"><input className="gm-input" value={form.kodePesanan} onChange={(e) => setForm({ ...form, kodePesanan: e.target.value })} placeholder="Resi / nama creator promosi" /></Field>
