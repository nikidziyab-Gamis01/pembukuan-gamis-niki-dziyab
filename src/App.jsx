...
// ---------- Dashboard & Fungsi Stat Pendukung ----------
  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1.3fr", gap: 16, alignItems: "stretch", marginBottom: 18 }}>
        ...
        <SectionCard title="🔥 5 Produk Terlaris (Top Selling)" subtitle="Berdasarkan Volume Produk Terjual">
          <div style={{ height: 220 }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={topProductsData} layout="vertical" margin={{ top: 5, right: 10, left: 10, bottom: 5 }}>
                ...
                <YAxis dataKey="sku" type="category" tick={{ fontSize: 11, fontWeight: 700, fill: C.primaryDark }} axisLine={{ stroke: C.border }} />
                <Tooltip contentStyle={{ fontSize: 11, borderRadius: 6 }} />
                <Bar dataKey="qty" fill={C.accent} radius={[0, 5, 5, 0]} barSize={18} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </SectionCard>
